...
Public Class frmuser
    ...
    Private Sub ShowUserDetails(rowIndex As Integer)
        ' Implement the logic to display user details
        Dim userDetails As String = String.Format("First Name: {0}{1}Last Name: {2}{1}Middle Name: {3}",
                                                  Guna2DataGridView1.Rows(rowIndex).Cells(1).Value.ToString(),
                                                  Environment.NewLine,
                                                  Guna2DataGridView1.Rows(rowIndex).Cells(2).Value.ToString(),
                                                  Guna2DataGridView1.Rows(rowIndex).Cells(3).Value.ToString())
    ...
    Private Sub FetchAndDisplayUserData(userId As Integer)
        ...
        Try
            ...
            If dr.Read() Then
                ...
                Else
                    PictureBox1.Image = My.Resources.eye_close_up ' Default or placeholder image
                End If
            End If
    ...
    Private Function IsStrongPassword(password As String) As Boolean
        ' Updated regex to allow all numbers or passwords that meet the original criteria
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        Else
            ...
            PictureBox2.Image = My.Resources.eye_close_up
        End If
    End Sub
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        Else
            ...
            PictureBox3.Image = My.Resources.eye_close_up
        End If
    End Sub
