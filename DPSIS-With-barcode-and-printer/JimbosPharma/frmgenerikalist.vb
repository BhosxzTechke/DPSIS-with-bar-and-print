Public Class frmgenerikalist
    ...
    Sub genericview()
        ...
        dr.Close()
        con.Close()
        Guna2HtmlLabel1.Text = " Record Found.(" & DataView.RowCount & ") "

    End Sub
    Private Sub frmgenerikalist_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        genericview()
    End Sub
    Sub Searchgeneric()
        Dim i As Integer = 0
    ...
    Private Sub frmgenerikalist_Leave(sender As Object, e As EventArgs) Handles MyBase.Leave
        With frmgeneric
            .txtgeneric.Clear()
            .btnupdate.Visible = False
