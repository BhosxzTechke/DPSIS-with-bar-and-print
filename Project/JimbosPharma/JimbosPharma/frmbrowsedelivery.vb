    ...
    Sub browseprod()
        ...
        Try
            ...
            While dr.Read()
                ...
                DataGridView1.Rows.Add(i, dr("id").ToString(), dr("barcode").ToString(), dr("item_des").ToString(), dr("brand").ToString(), dr("generic").ToString(), dr("Category").ToString(), dr("Formulations").ToString(), dr("Dosage").ToString(), dr("reorder").ToString(), dr("unit").ToString(), img)
            End While
                ...
                If MsgBox("Item Description: " & arr(0).ToString & vbCrLf &
                    ...
                    Else
                        ...
                        With targetForm.Guna2DataGridView1.Rows(newRowIndex)
                            ...
                            .Cells(4).Value = DataGridView1.Rows(e.RowIndex).Cells(2).Value.ToString() ' Barcode
                            .Cells(5).Value = DataGridView1.Rows(e.RowIndex).Cells(3).Value.ToString() ' Item description
