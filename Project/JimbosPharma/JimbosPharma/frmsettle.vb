        ...
        Try
            With cashier
                For i = 0 To .Guna2DataGridView1.RowCount - 1
                    con.Open()
                    cmd = New SqlClient.SqlCommand("Update tblproduct set qty = qty - " & CInt(.Guna2DataGridView1.Rows(i).Cells(11).Value.ToString) & "where id like '" & .Guna2DataGridView1.Rows(i).Cells(2).Value.ToString & "'", con)
                    cmd.ExecuteNonQuery()
                    con.Close()
                Next
