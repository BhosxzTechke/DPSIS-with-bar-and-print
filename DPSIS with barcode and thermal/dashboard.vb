...
Public Class dashboard
    ...
    Private Sub dashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Configure the single Guna Circle Progress Bar
        Guna2CircleProgressBar1.Maximum = 100
        Guna2CircleProgressBar1.ProgressColor = Color.Cyan ' Initial color
        Guna2CircleProgressBar1.Value = 0 ' Start at 0

        ' Configure Timer properties
        Timer3.Interval = 15 ' Adjust speed (lower = faster)
        Timer3.Enabled = True
        Timer3.Start()
    ...
    Private Sub Timer3_Tick(sender As Object, e As EventArgs) Handles Timer3.Tick
        ...
        ' Reset the progress to create an endless loop
        If Guna2CircleProgressBar1.Value >= Guna2CircleProgressBar1.Maximum Then
            Guna2CircleProgressBar1.Value = 0
            ' Toggle color each time it completes a loop
            If isColorCyan Then
                Guna2CircleProgressBar1.ProgressColor = Color.Magenta
            Else
                Guna2CircleProgressBar1.ProgressColor = Color.Cyan
            End If
            isColorCyan = Not isColorCyan ' Toggle the flag
        End If
    End Sub
